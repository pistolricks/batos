            ...
            <div
                ...
                <div class="flex items-center justify-between h-full w-screen px-4">
                    ...
                    <div class={"flex justify-end items-center"}>
                        <div class="mr-2">
                            <div
                                class="flex items-center bg-blue-400/10 border border-blue-400/30 rounded px-3 py-1 w-64 focus-within:border-blue-400/60 focus-within:bg-blue-400/20 transition-all duration-300">
                                            ...
                                            {(result) => (
                                                ...
                                                <span
                                                    ...
                                                    <div class="flex flex-col">
                                                        <span
                                                            class="text-sm text-blue-400 font-medium">{result.name}</span>
