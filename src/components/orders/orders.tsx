        ...
        <section class="bg-background h-screen w-screen antialiased dark:bg-gray-900">
            <div class="mx-auto max-w-7xl ">
                <div class="">
                    <div class="space-y-6 sm:space-y-8">
                        ...
                        <div class="relative py-4 h-dvh divide-y divide-gray-200 overflow-hidden  border border-gray-200 bg-gray-50 shadow-sm dark:divide-gray-700 dark:border-gray-700 dark:bg-gray-800">
                                ...
                                <div class="flex flex-col-reverse items-center justify-between md:flex-row md:space-x-4">
                                    ...
                                    <div class="mb-4 w-full md:mb-0 md:w-auto">
                                        <button
                                            ...
                                            type="button"
                                            class="flex w-full items-center justify-center rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700 md:w-auto"
                                        >
                                            Last 7 days
                                        ...
                                        <div id="dateDropdownButton" class="z-10 hidden w-80 divide-y divide-gray-100 rounded bg-gray-50 shadow dark:divide-gray-600 dark:bg-gray-700">
                    ...
                    <span class="me-2 inline-flex items-center rounded bg-primary-100 px-2.5 py-0.5 text-xs font-medium text-primary-800 dark:bg-primary-900 dark:text-primary-300">
                      ...
                      Pre-order
                                        ...
                                        <td class="p-4 text-right">
                                            ...
                                            <div id="dropdownOrder" class="z-10 hidden w-40 divide-y divide-gray-100 rounded-lg bg-gray-50 shadow dark:bg-gray-700">
                    ...
                    <span class="me-2 inline-flex items-center rounded bg-yellow-100 px-2.5 py-0.5 text-xs font-medium text-yellow-800 dark:bg-yellow-900 dark:text-yellow-300">
                      ...
                      In transit
                                        ...
                                        <td class="p-4 text-right">
                                            ...
                                            <div id="dropdownOrder2" class="z-10 hidden w-40 divide-y divide-gray-100 rounded-lg bg-gray-50 shadow dark:bg-gray-700">
                    ...
                    <span class="me-2 inline-flex items-center rounded bg-green-100 px-2.5 py-0.5 text-xs font-medium text-green-800 dark:bg-green-900 dark:text-green-300">
                      ...
                      Confirmed
                                        ...
                                        <td class="p-4 text-right">
                                            ...
                                            <div id="dropdownOrder3" class="z-10 hidden w-40 divide-y divide-gray-100 rounded-lg bg-gray-50 shadow dark:bg-gray-700">
                    ...
                    <span class="me-2 inline-flex items-center rounded bg-green-100 px-2.5 py-0.5 text-xs font-medium text-green-800 dark:bg-green-900 dark:text-green-300">
                      ...
                      Confirmed
                                        ...
                                        <td class="p-4 text-right">
                                            ...
                                            <div id="dropdownOrder4" class="z-10 hidden w-40 divide-y divide-gray-100 rounded-lg bg-gray-50 shadow dark:bg-gray-700">
                    ...
                    <span class="me-2 inline-flex items-center rounded bg-red-100 px-2.5 py-0.5 text-xs font-medium text-red-800 dark:bg-red-900 dark:text-red-300">
                      ...
                      Cancelled
                                        ...
                                        <td class="p-4 text-right">
                                            ...
                                            <div id="dropdownOrder5" class="z-10 hidden w-40 divide-y divide-gray-100 rounded-lg bg-gray-50 shadow dark:bg-gray-700">
                    ...
                    <span class="me-2 inline-flex items-center rounded bg-green-100 px-2.5 py-0.5 text-xs font-medium text-green-800 dark:bg-green-900 dark:text-green-300">
                      ...
                      Confirmed
                                        ...
                                        <td class="p-4 text-right">
                                            ...
                                            <div id="dropdownOrder6" class="z-10 hidden w-40 divide-y divide-gray-100 rounded-lg bg-gray-50 shadow dark:bg-gray-700">
                    ...
                    <span class="me-2 inline-flex items-center rounded bg-green-100 px-2.5 py-0.5 text-xs font-medium text-green-800 dark:bg-green-900 dark:text-green-300">
                      ...
                      Confirmed
                                        ...
                                        <td class="p-4 text-right">
                                            ...
                                            <div id="dropdownOrder7" class="z-10 hidden w-40 divide-y divide-gray-100 rounded-lg bg-gray-50 shadow dark:bg-gray-700">
                    ...
                    <span class="me-2 inline-flex items-center rounded bg-red-100 px-2.5 py-0.5 text-xs font-medium text-red-800 dark:bg-red-900 dark:text-red-300">
                      ...
                      Cancelled
                                        ...
                                        <td class="p-4 text-right">
                                            ...
                                            <div id="dropdownOrder8" class="z-10 hidden w-40 divide-y divide-gray-100 rounded-lg bg-gray-50 shadow dark:bg-gray-700">
                    ...
                    <span class="me-2 inline-flex items-center rounded bg-green-100 px-2.5 py-0.5 text-xs font-medium text-green-800 dark:bg-green-900 dark:text-green-300">
                      ...
                      Confirmed
                                        ...
                                        <td class="p-4 text-right">
                                            ...
                                            <div id="dropdownOrder9" class="z-10 hidden w-40 divide-y divide-gray-100 rounded-lg bg-gray-50 shadow dark:bg-gray-700">
                    ...
                    <span class="me-2 inline-flex items-center rounded bg-green-100 px-2.5 py-0.5 text-xs font-medium text-green-800 dark:bg-green-900 dark:text-green-300">
                      ...
                      Confirmed
                                        ...
                                        <td class="p-4 text-right">
                                            ...
                                            <div id="dropdownOrder10" class="z-10 hidden w-40 divide-y divide-gray-100 rounded-lg bg-gray-50 shadow dark:bg-gray-700">
            ...
            <div id="deleteOrderModal" tabindex="-1" aria-hidden="true" class="fixed left-0 right-0 top-0 z-50 hidden h-modal w-full items-center justify-center overflow-y-auto overflow-x-hidden md:inset-0 md:h-full">
                <div class="relative h-full w-full max-w-md p-4 md:h-auto">
                    ...
                    <div class="relative rounded-lg bg-gray-50 p-4 text-center shadow dark:bg-gray-800 sm:p-5">
                        ...
                        <div class="flex items-center justify-center space-x-4">
                            <button data-modal-toggle="deleteOrderModal" type="button" class="rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-sm font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-900 focus:z-10 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:border-gray-500 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white dark:focus:ring-gray-600">No, cancel</button>
