...
const UpdateProduct: Component<PROPS> = props => {
                    ...
                    <div
                        ...
                        <form action="#">
                            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <textarea id="description" rows="4"
                                              ...
                                              placeholder="Write your description...">Standard glass, 3.8GHz 8-core 10th-generation Intel Core i7 processor, Turbo Boost up to 5.0GHz, 16GB 2666MHz DDR4 memory, Radeon Pro 5500 XT with 8GB of GDDR6 memory, 256GB SSD storage, Gigabit Ethernet, Magic Mouse 2, Magic Keyboard - US</textarea>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="grid grid-cols-3 gap-4 mb-4 sm:grid-cols-4">
