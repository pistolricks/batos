        ...
        <section class="bg-background h-screen w-screen antialiased dark:bg-gray-900">
            <div class="mx-auto max-w-7xl">
                ...
                <div class="flex items-center justify-center lg:justify-start">
                    <a href="#" title=""
                       class="me-2 inline-flex items-center justify-center gap-2 rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700"
                       role="button">
