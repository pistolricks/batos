...
const UpdateCustomer: Component<PROPS> = props => {
    ...
    return (
            ...
            <div id="updateCustomerModal" tabindex="-1" aria-hidden="true"
                ...
                <div class=" max-h-full w-full max-w-4xl p-4">
                    ...
                    <div
                        class="bg-amber-50 absolute top-1/2 -translate-y-1/2 w-4/5 left-1/2 -translate-x-1/2  rounded-lg  p-4 shadow dark:bg-gray-800 sm:p-5">

                        <form action="#" class="relative ">

                            <div class="flex justify-between items-center py-4 px-4 rounded-t sm:px-5">
                            ...
                            <div id="accordion-collapse" data-accordion="collapse">
                                        ...
                                        <div class="grid gap-4 sm:grid-cols-2">
                                                ...
                                                <div class="items-center w-full sm:flex">
                                                    ...
                                                    <div class="w-full">
                                                        ...
                                                        <div class="flex items-center space-x-2.5">
                                                            <button type="button"
                                                                    class="inline-flex items-center py-2 px-3 text-xs font-medium text-center text-white bg-primary-700 rounded-lg hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                                                                <svg class="mr-1 -ml-1 w-4 h-4" fill="currentColor"
                                                                     viewBox="0 0 20 20"
                                                                     xmlns="http://www.w3.org/2000/svg">
                                                                    <path fill-rule="evenodd"
                                            ...
                                            <div>
                                                <label for="first-name"
                                                    ...
                                                    Name</label>
                                                <input type="text" name="first-name" id="first-name" value="Bonnie"
                                            ...
                                            <div>
                                                <label for="last-name"
                                                    ...
                                                    Name</label>
                                                <input type="text" name="last-name" id="last-name" value="Green"
                                                       class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                       placeholder="Doe"/>
                                            </div>
                                            <div>
                                                ...
                                                <label for="user-permissions"
                                                    ...
                                                    <button type="button" data-tooltip-target="tooltip-dark"
                                                        ...
                                                        <svg aria-hidden="true"
                                                             class="w-4 h-4 text-gray-400 dark:text-gray-500 hover:text-gray-900 dark:hover:text-white"
                                                    ...
                                                    <div id="tooltip-dark" role="tooltip"
                                                        ...
                                                        User permissions, part of the overall user management process,
                                                        are access granted to users to specific resources such as files,
                                            ...
                                            <div>
                                                <label for="user-role"
                                                       class="inline-flex items-center mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                                    User Role
                                                    <button type="button" data-tooltip-target="tooltip-user-role"
                                                            data-tooltip-style="dark" class="ml-1">
                                                        <svg aria-hidden="true"
                                                    ...
                                                    <div id="tooltip-user-role" role="tooltip"
                                                         class="inline-block absolute invisible z-10 py-2 px-3 max-w-sm text-xs font-normal text-white bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                                        Flowbite provides 7 predefined roles: Owner, Admin, Editor,
                                                        Contributor and Viewer. Assign the most suitable role to each
                                                        user, giving them the most appropriate level of control.
                                                        <div class="tooltip-arrow" data-popper-arrow></div>
                                                    </div>
                                                </label>
                                                <select id="user-role"
                                            ...
                                            <div class="sm:col-span-2">
                                                <label for="email-status"
                                                       class="inline-flex items-center mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                                    Email Status
                                                    <button type="button" data-tooltip-target="tooltip-email-status"
                                                            data-tooltip-style="dark" class="ml-1">
                                                        <svg aria-hidden="true"
                                                             class="ml-1 w-4 h-4 text-gray-400 dark:text-gray-500 hover:text-gray-900 dark:hover:text-white"
                                                             fill="currentColor" viewBox="0 0 20 20"
                                                    ...
                                                    <div id="tooltip-email-status" role="tooltip"
                                                         class="inline-block absolute invisible z-10 py-2 px-3 max-w-sm text-xs font-normal text-white bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                                        As an administrator, you can view the status of a user's email.
                                                        The status indicates whether a user's email is verified or not.
                                                        <div class="tooltip-arrow" data-popper-arrow></div>
                                                    </div>
                                                </label>
                                            ...
                                            <div class="sm:col-span-2">
                                                <label
                                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                                    for="role">Assign Role</label>
                                                <div class="flex space-x-4">
                                                    <div class="flex items-center">
                                                        <input id="inline-checkbox" type="checkbox" value="" name="role"
                                                    ...
                                                    <div class="flex items-center">
                                                        <input id="inline-checked-checkbox" type="checkbox" value=""
                                                               name="role"
                                                               class="w-4 h-4 bg-gray-100 rounded border-gray-300 text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                                ...
                                <h2 id="accordion-collapse-heading-2">
                                    <button type="button"
                                            class="flex justify-between items-center py-4 px-4 w-full font-medium leading-none text-left text-gray-900 bg-gray-50 border-t border-gray-200 sm:px-5 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-white hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600"
                                ...
                                <div id="accordion-collapse-body-2" class="hidden"
                                    ...
                                    <div class="px-4 pt-4 border-gray-200 sm:px-5 sm:pt-5 dark:border-gray-700">
                                        ...
                                        <div class="grid gap-4 sm:grid-cols-2">
                                            ...
                                            <div class="col-span-2 sm:col-span-1">
                                                <label for="personal-website"
                                                    ...
                                                    Website</label>
                                                <input type="url" name="personal-website" id="personal-website"
                                            ...
                                            <div class="col-span-2 sm:col-span-1">
                                                <label for="timezone"
                                                       class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Timezone</label>
                                                <input type="text" name="timezone" id="timezone" value="GMT+3"
                                                       class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                            ...
                                            <div class="col-span-2">
                                                ...
                                                <textarea id="biography" rows="4"
                                                          class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 placeholder:text-gray-900 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                          placeholder="Write your biography...">Hello, I'm Helene Engels, USA Designer, Creating things that stand out, Featured by Adobe, Figma, Webflow and others, Daily design tips & resources, Exploring Web3.</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="flex items-center py-4 px-4 space-x-4 sm:py-5 sm:px-5">
                                <button type="submit"
